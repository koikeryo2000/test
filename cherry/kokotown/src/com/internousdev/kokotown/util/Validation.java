...
public class Validation {
	...
	public String familyNameChk(String familyName) {
		...
		} else if (!familyName.matches("^[a-zA-Z0-9ぁ-んァ-ヶ一-龠々!-~-ー]+$")) {
			result = "姓は半角英語または漢字、カタカナ、ひらがなで入力してください。";
		}
	...
	public String firstNameChk(String firstName) {
		...
		} else if (!firstName.matches("^[a-zA-Z0-9ぁ-んァ-ヶ一-龠々!-~-ー]+$")) {
				result = "名は半角英語または漢字、カタカナ、ひらがなで入力してください。";
		}
	...
	public String emailChk(String email) {
		...
		} else if (email.length() < 6 || email.length() > 32) {
			result = "メールアドレスは6文字以上32文字以下で入力してください。";
	...
	public String userIdChk(String userId) {
		...
		if (userId.equals("")) {
			...
			result = "ログインIDは4文字以上16文字以下で入力してください。";
	...
	public String userAddressChk(String userAddress) {
		...
		} else if (!userAddress.matches("^[a-zA-Z0-9ぁ-んァ-ヶ一-龠々!-~-ー]+$")) {
